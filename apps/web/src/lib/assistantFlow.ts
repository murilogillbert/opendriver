...
export const assistantWelcomeText =
  "Oi, sou o assistente da DriverHub. Vou entender seu perfil rapidinho e te mostrar o melhor caminho para aumentar seu ganho.";
...
> = {
  fuel: {
    ...
    response:
      "Combustível costuma pesar muito na rotina. Para esse perfil, a DriverHub destaca economia por abastecimento e parceiros para reduzir o custo por corrida.",
  ...
  maintenance: {
    ...
    response:
      "Manutenção também come margem. A DriverHub pode direcionar você para vantagens com oficinas parceiras e serviços essenciais com preço menor.",
  ...
  cashback: {
    ...
    response:
      "Boa. Cashback ajuda a transformar gastos recorrentes em retorno. A DriverHub organiza benefícios para você aproveitar melhor os serviços do dia a dia.",
  ...
  earnings: {
    ...
    response:
      "Perfeito. Quando o custo por corrida cai, o ganho líquido melhora. A DriverHub foca em benefícios práticos para sobrar mais no fim do mês.",
  ...
  benefits: {
    ...
    response:
      "Esse é o coração da DriverHub: reunir vantagens úteis para motorista em um só lugar, com ativação simples e atendimento direto.",
  ...
  support: {
    ...
    response:
      "Você não precisa ficar tentando entender tudo sozinho. A DriverHub direciona o atendimento para explicar os benefícios e te ajudar na ativação.",
